...
static void DecorationItemsMenu_PrintDecorationInUse(const struct ListMenu* list, u32 itemIndex, u8 y);
...
static void DecorationItemsMenu_PrintDecorationInUse(const struct ListMenu* list, u32 index, u8 y)
{
