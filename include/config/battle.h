...
#define B_FLAG_NO_WHITEOUT          FLAG_TARC3_NO_WHITEOUT // If this flag is set, the player can not white out against Trainers. Please note that the party is not healed automatically!
