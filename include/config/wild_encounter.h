...
#define WE_OWE_UNRESTRICT_SIGHT                 TRUE   // If TRUE, OWEs with movement behaviors that respond to the player, will ignore all movement restrictions when they can see the player.
...
#define WE_OWE_FLEE_DESPAWN                     FALSE    // If TRUE, a fleeing OWE will despawn if it is unable to take a step for a short time.
