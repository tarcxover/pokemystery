...
enum __attribute__((packed)) Item
{
    ...
    // Evidence Items
    ITEM_EVIDENCE_START,
    #define EVIDENCE_ITEMS(n, id)  CAT(ITEM_, id) = APPEND_COMMA(ITEM_EVIDENCE_START + REMOVE_LEADING_ZEROES(n))
    #define _APPEND_COMMA_TO_EVD(...) APPEND_COMMA(FIRST(__VA_ARGS__))
    #define _NUMBERS_256_NO_LEAD_ZERO R_FOR_EACH(REMOVE_LEADING_ZEROES, UNPACK_B(NUMBERS_256))
    RECURSIVELY(R_ZIP(EVIDENCE_ITEMS, NUMBERS_256 ,(FOREACH_EVIDENCE(_APPEND_COMMA_TO_EVD))))
    #undef _APPEND_COMMA_TO_EVD
